...
class CloudMoviezSettingsFragment(private val plugin: Plugin) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        fun cfSaved(): Boolean = CMZCFStore.getSession("new.cloudmoviez.shop") != null ||
                CMZCFStore.getSession("new4.gdflix.io") != null
        ...
        bypassBtn.setOnClickListener {
            ...
            try {
                ...
                Log.e("CMZ_Settings", "clear: ${e.message}")
            }
            for (host in hosts) {
                CMZCFStore.clear(host.removePrefix("https://"))
            }

            bypassBtn.text = "Solving..."
            CoroutineScope(Dispatchers.Main).launch {
                try {
                    val success = showCMZCFBypassDialogAndWait(hosts[0])
                    bypassBtn.text = if (success && cfSaved()) "CF Cookies Saved" else "Bypass Cloudflare"

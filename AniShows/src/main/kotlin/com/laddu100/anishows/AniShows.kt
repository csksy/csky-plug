...
class AniShows : MainAPI() {
    ...
    private suspend fun loadTv(tmdbId: Int, url: String): LoadResponse? {
        ...
        for (season in seasons) {
            ...
            seasonData.episodes?.forEach { ep ->
                ...
                episodes.add(newEpisode(EpisodeData(tmdbId, "tv", seasonNum, epNum).toJson()) {
                    this.episode = epNum
    ...
    private suspend fun loadMovie(tmdbId: Int, url: String): LoadResponse? {
        ...
        return newMovieLoadResponse(title, url, TvType.Movie, EpisodeData(tmdbId, "movie", 0, 0).toJson()) {

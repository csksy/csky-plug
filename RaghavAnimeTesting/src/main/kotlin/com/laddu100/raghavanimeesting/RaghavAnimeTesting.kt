...
import com.laddu100.raghavanimeesting.settings.SettingsFragment
...
class RaghavAnimeTesting : MainAPI() {
    override var mainUrl = "https://graphql.anilist.co"
    override var name = "RaghavAnimeTesting"
    ...
    override suspend fun loadLinks(
        ...
        if (SettingsFragment.isSubDLEnabled()) {
            try {
        ...
        if (com.laddu100.raghavanimeesting.AISubtitleHelper.isEnabled() && isDub && collectedLinks.isNotEmpty()) {
            try {
                ...
                com.laddu100.raghavanimeesting.AISubtitleHelper.generateAISubtitles(

...
class OnlyTesting : MainAPI() {
    override var mainUrl = "https://graphql.anilist.co"
    override var name = "OnlyTesting"
    ...
    override suspend fun loadLinks(
        ...
        if (com.laddu100.onlytesting.AISubtitleHelper.isEnabled() && isDub && collectedLinks.isNotEmpty()) {
            try {
                ...
                com.laddu100.onlytesting.AISubtitleHelper.generateAISubtitles(

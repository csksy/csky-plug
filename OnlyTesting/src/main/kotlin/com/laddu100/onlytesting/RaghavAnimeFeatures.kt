...
object RaghavAnimeFeatures {
    ...
    fun shouldRunSource(sourceKey: String): Boolean { val p = getActiveCustomProfile(); if (p != null) return sourceKey in p.sources; return com.laddu100.onlytesting.settings.SettingsFragment.isEnabled(sourceKey) }
